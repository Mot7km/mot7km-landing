...
import { Menu, X, Moon, Sun, ArrowRight, Languages } from "lucide-react";
    ...
    <header className="fixed top-4 left-0 right-0 z-50 flex justify-center px-4 pointer-events-none transition-all duration-300">
      ...
      >
        ...
        <Link href="/" className="flex items-center gap-3 shrink-0 pl-2 group">
          ...
          <span className="font-extrabold text-lg tracking-tight text-text-primary group-hover:translate-x-0.5 transition-transform duration-300">
            Mot7km
          </span>
        </Link>
