...
export default function Hero() {
  ...
  const dashboardX = useTransform(mouseX, [-0.5, 0.5], [30, -30]);
  const dashboardY = useTransform(mouseY, [-0.5, 0.5], [30, -30]);

  const posX = useTransform(mouseX, [-0.5, 0.5], [-40, 40]);
  const posY = useTransform(mouseY, [-0.5, 0.5], [-40, 40]);

  const mobileX = useTransform(mouseX, [-0.5, 0.5], [50, -50]);
  const mobileY = useTransform(mouseY, [-0.5, 0.5], [50, -50]);
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-12 mb-20">
          ...
          <div className="flex-1 text-center lg:text-start z-20">
            ...
            <motion.div
              ...
              className="mt-12 flex flex-wrap items-center justify-center lg:justify-start gap-4 lg:gap-6 text-text-muted text-sm font-medium"
            >
          ...
          >
            ...
            {/* Layer 3: Mobile App (Front Center) */}
            <motion.div
