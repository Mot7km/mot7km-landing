...
export default function PrivacyPolicy() {
  ...
  const sections = Array.from({ length: 16 }, (_, i) => ({
    title: t(`privacy.sections.s${i + 1}.title`),
    content: t(`privacy.sections.s${i + 1}.content`),
  }));
            ...
            {sections.map((section, index) => (
              ...
              >
                ...
                <div className="pl-4 border-l-2 border-primary/20 rtl:pl-0 rtl:pr-4 rtl:border-l-0 rtl:border-r-2 group-hover:border-primary transition-colors duration-300">
                  <p className="text-text-secondary leading-relaxed md:text-lg whitespace-pre-wrap">
                    {section.content}
                  </p>
                </div>
